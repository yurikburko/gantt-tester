...
import { daysDiff } from '@/utils/dateUtility';
...
export const GanttTask: FC<GanttTaskProps> = ({ task, x, y, rowHeight, zoomScale }) => {
    const duration = daysDiff(task.start!, task.end!) + 1;
    const width = Math.floor(duration * zoomScale + 1);
